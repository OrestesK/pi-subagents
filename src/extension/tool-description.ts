...
• Async/background runs: launch with async:true only when work can proceed independently. Do not sleep or poll status just to wait. Persistent interactive parents should continue useful work or applicable Slack work, or yield; completion notifications resume them without another user prompt. Use the wait tool only for non-yielding/run-to-completion flows or a named same-control-flow dependency; prefer foreground execution for a known immediate dependency.
...
ASYNC / WAIT:
• async:true detaches background work. Do not sleep or poll just to wait. Persistent interactive parents should continue useful work or applicable Slack work, or yield; completion notifications resume them without another user prompt. Use the wait tool only for non-yielding/run-to-completion flows or a named same-control-flow dependency; prefer foreground execution for a known immediate dependency.
